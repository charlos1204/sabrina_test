# -*- coding: utf-8 -*-
import unittest
import sabrina_test.models.deepaas_api as deepaas_api
...
class TestModelMethods(unittest.TestCase):
    ...
    def test_model_metadata_values(self):
        ...
        self.assertEqual(self.meta['Name'].replace('-','').replace('_',''),
                        'sabrina_test'.replace('-','').replace('_',''))
        self.assertEqual(self.meta['Author'], 'sabrina')
        self.assertEqual(self.meta['Author-email'], '    carlos.garcia@helmholtz-muenchen.de ')
